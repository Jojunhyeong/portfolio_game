...
export default function StartMenu() {
  ...
  return (
    <section className="panel p-6 md:p-10 sweep overflow-y-hidden">
      {/* TOP */}
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-4 text-b5 muted">
            Shortcut: <span className="accent">C</span> Projects ·{' '}
...
<div className="flex items-start gap-4 md:justify-end">
  ...
  <div className="relative h-40 w-40 shrink-0">
    ...
    <div
      ...
      style={{
        background:
          'linear-gradient(180deg, rgba(var(--accent), .85), rgba(var(--accent-2), .65))',
      }}
    />
    ...
    {/* online dot 예시 (원하면) */}
    {/* <div className="absolute bottom-2 right-2 h-3 w-3 rounded-full bg-emerald-400 ring-2 ring-black/30" /> */}
  </div>
