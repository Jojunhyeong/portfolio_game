    ...
    <div className="space-y-6">
      ...
      <section className="panel p-6 md:p-10">
        ...
        <p className="text-b3 muted mt-3 typo max-w-[70ch]">
          ...
          생각했습니다.
          <br />
          그래서 문제를 만났던 순간, 새롭게 시도했던 선택, 그리고 개선의 결과를 <span className="accent">Patch Notes</span>로 남겼습니다.
        </p>
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <a className="btn text-b5" href="https://velog.io/@jojh0323/posts" target="_blank" rel="noreferrer">
            ✎ Velog 전체 보기 →
          </a>
          <span className="panel px-3 py-2 text-b5 muted">프로젝트별 Patch Notes는 Projects 내부에 있습니다</span>
        </div>
      </section>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-b3 muted mt-2 typo">
                단순한 문제 해결 모음이 아니라, 제가 <span className="accent">새롭게 시도했던 것</span> 중 흐름을 바꿨던 기록을 골랐습니다.
              </p>
            </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {curated.map((n) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className={['block', 'panel panel-glow sweep', 'p-6 md:p-7', 'hover:-translate-y-1', 'transition-transform duration-150'].join(
                  ' ',
                )}
              >
                <div className="flex items-start justify-between gap-4">
